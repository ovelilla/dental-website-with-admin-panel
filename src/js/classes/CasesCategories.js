...
class CasesCategories {
    ...
    async readCategoriesInUse() {
        const response = await api.get("/api/cases/categories");
    ...
    async createCategory() {
        const response = await api.post("/api/admin/cases-categories", this.values);
    ...
    async updateCategory() {
        ...
        const response = await api.put("/api/admin/cases-categories", this.category);
    ...
    async deleteCategory(category) {
        ...
        const response = await api.delete("/api/admin/cases-categories", data);
