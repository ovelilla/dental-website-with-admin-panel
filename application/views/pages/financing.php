...
<section class="section financing">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-right">
                <img loading="lazy" src="/build/img/varios/diagnostico.jpg" alt="Ilustración diagnostico">
            </div>
        </div>

        <div class="row">
            <div class="col-left">
                <img loading="lazy" src="/build/img/varios/financiacion.jpg" alt="Ilustración financiación">
            </div>
            ...
            <div class="col-right">
                <div class="steps">
                    <div class="step">
                        ...
                        <div class="right">
                            <h2 class="title">Plan de pago</h2>
                            <p class="text">Nuestro equipo junto a ti buscaremos un plan de pago flexible y adaptado a las necesidades de cada paciente, porque nuestro destino es tu sonrisa.</p>
                        </div>
                    </div>
                    ...
                    <div class="step">
                        ...
                        <div class="right">
                            <h2 class="title">Éxito garantizado</h2>
                            <p class="text">Un tratamiento bien hecho desde el principio, de la mano de los mejores profesionales, la mejor tecnología y la mejor calidad te proporcionaran tranquilidad y un éxito garantizado.</p>
                        </div>
                    </div>
                </div>
            </div>
