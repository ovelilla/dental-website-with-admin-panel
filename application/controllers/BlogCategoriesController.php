...
class BlogCategoriesController {
    ...
    public static function createCategory(Router $router) {
        ...
        $exists_category = DB::table('blog_categories')
            ->select()
        ...
        try {
            $insert_data = DB::table('blog_categories')
    ...
    public static function updateCategory(Router $router) {
        ...
        $exists_category_alias = DB::table('blog_categories')
            ->select('alias')
            ->where('alias', '=', $category->getAlias())
            ->limit(1)
            ->getOne();

        $exists_category_id = DB::table('blog_categories')
            ->select('alias')
