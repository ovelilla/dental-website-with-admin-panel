...
class CasesPost {
    private string $table = 'cases_posts';
    private array $columns = ['id', 'user_id', 'before_id', 'after_id', 'category_id', 'title', 'alias', 'description', 'html', 'created_at', 'updated_at'];
    ...
    public function __construct($args = []) {
        ...
        $this->before_id = $args['before_id'] ?? '';
        $this->after_id = $args['after_id'] ?? '';
    ...
    public function setBeforeId(string $before_id): void {
    ...
    public function setAfterId(string $after_id): void {
