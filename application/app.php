...
$router->get('/equipo/dra-aurora', [PagesController::class, 'aurora'], false);
...
$router->get('/implantes-dentales', [PagesController::class, 'dentalImplants'], false);
$router->get('/blanqueamiento-dental', [PagesController::class, 'teethWhitening'], false);
$router->get('/ortodoncia-invisible', [PagesController::class, 'invisalign'], false);
$router->get('/ortodoncia', [PagesController::class, 'orthodontics'], false);
$router->get('/periodoncia', [PagesController::class, 'periodontics'], false);
$router->get('/endodoncia', [PagesController::class, 'endodontics'], false);
$router->get('/estetica-dental', [PagesController::class, 'dentalAesthetics'], false);
$router->get('/rehabilitacion-oral-protesis-dentales', [PagesController::class, 'oralRehabilitationDentalProsthesis'], false);
$router->get('/cirugia-dental', [PagesController::class, 'dentalSurgery'], false);
$router->get('/odontopediatria', [PagesController::class, 'pediatricDentistry'], false);
$router->get('/odontologia-conservadora', [PagesController::class, 'conservativeDentistry'], false);
$router->get('/bruxismo', [PagesController::class, 'bruxism'], false);
$router->get('/apnea-sueno-roncopatia', [PagesController::class, 'sleepApneaSnoring'], false);
$router->get('/acido-hialuronico', [PagesController::class, 'hyaluronicAcid'], false);
$router->get('/halitosis', [PagesController::class, 'halitosis'], false);
...
$router->post('/api/admin/patients/email', [PatientsController::class, 'sendEmail'], true);
